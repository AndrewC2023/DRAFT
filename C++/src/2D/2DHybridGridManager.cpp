...
namespace Algorithms::TwoD 
{
    ...
    HybridGridManager2D::HybridGridManager2D(float p_minX, float p_maxX,
    ...
    HybridGridManager2D::~HybridGridManager2D(){
    ...
    std::vector<Cell> HybridGridManager2D::getNeighbors(float x, float y, int depth)   
    {
    ...
    void HybridGridManager2D::addKnownObstacle(float x, float y)  
    {
    ...
    PointXY HybridGridManager2D::getNearestObstacleCenter(PointXY PointOfReference)
    {
    ...
    void HybridGridManager2D::getGridDomain(float& xMin, float& xMax, float& yMin, float& yMax)
    {
        xMin = _xMin;
        xMax = _xMax;
        yMin = _yMin;
    ...
    const float HybridGridManager2D::getCellSize(){
        return _cellSize;
    } // getCellSize

    const IndexXY HybridGridManager2D::getIndexContainingPoint(const PointXY point)
    {
