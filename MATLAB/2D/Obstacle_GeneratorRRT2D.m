...
% currently unused for RRT*, replaced by a maze that is a guaranteed solve
h = 10;
w = 10;
...
for i = 1:h
    for j = 1:w
        ...
        % Make sure there is a guarranteed solution

        if i == Waypoint.Start(1) || i == Waypoint.End(1) || j == Waypoint.Start(2) || j == Waypoint.End(2)
            Obstacle_MAP(i,j) = 0;
        end
